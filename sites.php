...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="index.php">
            <img width="113" height="27" src='assets/images/Codeit.png'/>
          </a>
        </div>
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <form action="search.php" class="form-inline">
            <div class="form-group">
              <input name="q" type="search" style="width: 300px;" placeholder="aye aye, search" class="form-control box input-lg" id="search_box">
            </div>
          </form>
        </div><!--/.nav-collapse -->
      </div>
    ...
    <div data-remodal-id="modal">
      ...
      <big> <cite title="close dialog"> Put in background (Ctrl + X) </cite> </big>
    </div>

    <div class="container remodal-bg">
      <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="#add">Index websites</a></li>
          ...
          <div class="row table-responsive" style="margin: 0 auto;">
            <div class="col-md-12">
              ...
              <table class="table table-bordered table-striped">
                ...
                if ($c === 0) {
                    echo "<h3>No Website Indexed !</h3><br>";
                } else {
